...
<body >
  ...
  <!--header for system heardermenu tooltip dropdown-->
    ...
    <img src="icon.png" style="width:100px;margin-top:-20px">
	<br>
	<button style="float:right;margin-top:-60px;margin-right:10px" type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">
      login
   </button>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
	   ...
	   <div style="margin-top:-60px;margin-right:78px;display:block" class="container">        		
